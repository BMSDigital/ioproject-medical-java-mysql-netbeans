...
public class Marca_Inventario extends javax.swing.JPanel{
    ...
    public void setEgoistStyle(){
        ...
        (new ToolTip(AppView.loadImage("tooltip.png"),txtcategoria, "<html><left>Introduzca el nombre de la marca del producto.</left></html>",300)).build();
    ...
    private void initComponents() {
        ...
        panel_categoria.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 2, true), "Marca del producto", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI Light", 0, 24), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 2, true), "Marca", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI Light", 0, 24), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jLabel8.setText("<html><center><p>MARCA</p></html>");
    ...
    private void btguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btguardarActionPerformed
        Ajustes.Modelo.Marca marca = new Ajustes.Modelo.Marca();
        ...
        marca.setFecha(new Date(a,m,d).toString());
        marca.setMarca(txtcategoria.getText());
        ...
        {
            boolean res= Ajustes.Controlador.Application.onmarca(marca);
        if( res == true )
        {

...
public class Unidad_Inventario extends javax.swing.JPanel{
    ...
    public void setEgoistStyle(){
        ...
        (new ToolTip(AppView.loadImage("tooltip.png"),txtcategoria, "<html><left>Introduzca la unidad de medida del producto.</left></html>",300)).build();
    ...
    private void initComponents() {
        ...
        panel_categoria.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 2, true), "Unidades de medidas", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI Light", 0, 24), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 2, true), "Medidas", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI Light", 0, 24), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jLabel8.setText("<html><center><p>MEDIDA/UND</p></html>");
        ...
        jLabel9.setText("<html><center><p>PREFIJO</p></html>");
    ...
    private void btguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btguardarActionPerformed
        Ajustes.Modelo.Unidades unidad = new Ajustes.Modelo.Unidades();
        ...
        unidad.setFecha(new Date(a,m,d).toString());
        unidad.setMedida(txtcategoria.getText());
        unidad.setPrefijo(txtdescripcion.getText());
        ...
        {
            boolean res= Ajustes.Controlador.Application.onunidades(unidad);
        if( res == true )
        {

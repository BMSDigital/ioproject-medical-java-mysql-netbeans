...
public class Proveedor extends javax.swing.JPanel{
    ...
    public void setEgoistStyle(){
        ...
        (new ToolTip(AppView.loadImage("tooltip.png"),txtdireccion, "<html><left>Introduzca la dirección o ubicación.</left></html>",300)).build();
    ...
    private void initComponents() {
        ...
        jLabel12.setText("<html><center><p>DIRECCIÓN</p></html>");
